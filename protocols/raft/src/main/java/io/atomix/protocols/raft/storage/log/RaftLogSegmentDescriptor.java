 ...
 */
public final class RaftLogSegmentDescriptor {
   ...
   * @throws NullPointerException if {@code buffer} is null
   */
  public RaftLogSegmentDescriptor(ByteBuffer buffer) {
    this.buffer = buffer;
   ...
   */
  RaftLogSegmentDescriptor copyTo(ByteBuffer buffer) {
  ...
  public static class Builder {
    ...
    public RaftLogSegmentDescriptor build() {
      buffer.rewind();
      return new RaftLogSegmentDescriptor(buffer);
    }
  }
}

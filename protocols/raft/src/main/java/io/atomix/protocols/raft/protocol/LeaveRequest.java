 ...
 * cluster, it must submit a leave request to the leader. The leader will attempt to commit the configuration change
 * and, if successful, respond to the join request with the updated configuration.
 */
public class LeaveRequest extends ConfigurationRequest {

  public static LeaveRequest request(RaftMember member) {
